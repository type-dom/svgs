...
export class FlPinOffRegularSvg extends TypeSvgSvg {
  className: 'FlPinOffRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPinOffRegularSvg';
    this.attr.addObj({
      name: 'FlPinOffRegularSvg',
      title: 'FlPinOffRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
