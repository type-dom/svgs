...
export class FlDismissRegularSvg extends TypeSvgSvg {
  className: 'FlDismissRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDismissRegularSvg';
    this.attr.addObj({
      name: 'FlDismissRegularSvg',
      title: 'FlDismissRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
