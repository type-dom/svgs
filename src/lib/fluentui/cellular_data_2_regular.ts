...
export class FlCellularData2RegularSvg extends TypeSvgSvg {
  className: 'FlCellularData2RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCellularData2RegularSvg';
    this.attr.addObj({
      name: 'FlCellularData2RegularSvg',
      title: 'FlCellularData2RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
