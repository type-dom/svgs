...
export class FlClipboardClockRegularSvg extends TypeSvgSvg {
  className: 'FlClipboardClockRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlClipboardClockRegularSvg';
    this.attr.addObj({
      name: 'FlClipboardClockRegularSvg',
      title: 'FlClipboardClockRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
