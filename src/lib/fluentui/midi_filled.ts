...
export class FlMidiFilledSvg extends TypeSvgSvg {
  className: 'FlMidiFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlMidiFilledSvg';
    this.attr.addObj({
      name: 'FlMidiFilledSvg',
      title: 'FlMidiFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
