...
export class FlHeadphonesSoundWaveRegularSvg extends TypeSvgSvg {
  className: 'FlHeadphonesSoundWaveRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlHeadphonesSoundWaveRegularSvg';
    this.attr.addObj({
      name: 'FlHeadphonesSoundWaveRegularSvg',
      title: 'FlHeadphonesSoundWaveRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
