...
export class FlPremiumFilledSvg extends TypeSvgSvg {
  className: 'FlPremiumFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPremiumFilledSvg';
    this.attr.addObj({
      name: 'FlPremiumFilledSvg',
      title: 'FlPremiumFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
