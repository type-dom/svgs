...
export class FlRenameFilledSvg extends TypeSvgSvg {
  className: 'FlRenameFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlRenameFilledSvg';
    this.attr.addObj({
      name: 'FlRenameFilledSvg',
      title: 'FlRenameFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
