...
export class FlMicFilledSvg extends TypeSvgSvg {
  className: 'FlMicFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlMicFilledSvg';
    this.attr.addObj({
      name: 'FlMicFilledSvg',
      title: 'FlMicFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
