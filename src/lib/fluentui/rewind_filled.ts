...
export class FlRewindFilledSvg extends TypeSvgSvg {
  className: 'FlRewindFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlRewindFilledSvg';
    this.attr.addObj({
      name: 'FlRewindFilledSvg',
      title: 'FlRewindFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
