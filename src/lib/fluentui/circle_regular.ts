...
export class FlCircleRegularSvg extends TypeSvgSvg {
  className: 'FlCircleRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCircleRegularSvg';
    this.attr.addObj({
      name: 'FlCircleRegularSvg',
      title: 'FlCircleRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
