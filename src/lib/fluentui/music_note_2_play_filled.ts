...
export class FlMusicNote2PlayFilledSvg extends TypeSvgSvg {
  className: 'FlMusicNote2PlayFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlMusicNote2PlayFilledSvg';
    this.attr.addObj({
      name: 'FlMusicNote2PlayFilledSvg',
      title: 'FlMusicNote2PlayFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
