...
export class FlTextIndentDecreaseFilledSvg extends TypeSvgSvg {
  className: 'FlTextIndentDecreaseFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTextIndentDecreaseFilledSvg';
    this.attr.addObj({
      name: 'FlTextIndentDecreaseFilledSvg',
      title: 'FlTextIndentDecreaseFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
