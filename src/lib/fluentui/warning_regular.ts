...
export class FlWarningRegularSvg extends TypeSvgSvg {
  className: 'FlWarningRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlWarningRegularSvg';
    this.attr.addObj({
      name: 'FlWarningRegularSvg',
      title: 'FlWarningRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
