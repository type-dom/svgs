...
export class FlArrowForwardFilledSvg extends TypeSvgSvg {
  className: 'FlArrowForwardFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowForwardFilledSvg';
    this.attr.addObj({
      name: 'FlArrowForwardFilledSvg',
      title: 'FlArrowForwardFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
