...
export class FlArrowBidirectionalUpDownRegularSvg extends TypeSvgSvg {
  className: 'FlArrowBidirectionalUpDownRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowBidirectionalUpDownRegularSvg';
    this.attr.addObj({
      name: 'FlArrowBidirectionalUpDownRegularSvg',
      title: 'FlArrowBidirectionalUpDownRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
