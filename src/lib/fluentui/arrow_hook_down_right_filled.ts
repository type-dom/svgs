...
export class FlArrowHookDownRightFilledSvg extends TypeSvgSvg {
  className: 'FlArrowHookDownRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowHookDownRightFilledSvg';
    this.attr.addObj({
      name: 'FlArrowHookDownRightFilledSvg',
      title: 'FlArrowHookDownRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
