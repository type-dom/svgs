...
export class FlCameraDomeRegularSvg extends TypeSvgSvg {
  className: 'FlCameraDomeRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCameraDomeRegularSvg';
    this.attr.addObj({
      name: 'FlCameraDomeRegularSvg',
      title: 'FlCameraDomeRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
