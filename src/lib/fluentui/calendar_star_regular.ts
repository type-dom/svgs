...
export class FlCalendarStarRegularSvg extends TypeSvgSvg {
  className: 'FlCalendarStarRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCalendarStarRegularSvg';
    this.attr.addObj({
      name: 'FlCalendarStarRegularSvg',
      title: 'FlCalendarStarRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
