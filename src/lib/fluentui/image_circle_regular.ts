...
export class FlImageCircleRegularSvg extends TypeSvgSvg {
  className: 'FlImageCircleRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlImageCircleRegularSvg';
    this.attr.addObj({
      name: 'FlImageCircleRegularSvg',
      title: 'FlImageCircleRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
