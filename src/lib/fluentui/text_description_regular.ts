...
export class FlTextDescriptionRegularSvg extends TypeSvgSvg {
  className: 'FlTextDescriptionRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextDescriptionRegularSvg';
    this.attr.addObj({
      name: 'FlTextDescriptionRegularSvg',
      title: 'FlTextDescriptionRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
