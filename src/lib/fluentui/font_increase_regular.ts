...
export class FlFontIncreaseRegularSvg extends TypeSvgSvg {
  className: 'FlFontIncreaseRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlFontIncreaseRegularSvg';
    this.attr.addObj({
      name: 'FlFontIncreaseRegularSvg',
      title: 'FlFontIncreaseRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
