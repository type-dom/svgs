...
export class FlBuildingRetailShieldRegularSvg extends TypeSvgSvg {
  className: 'FlBuildingRetailShieldRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBuildingRetailShieldRegularSvg';
    this.attr.addObj({
      name: 'FlBuildingRetailShieldRegularSvg',
      title: 'FlBuildingRetailShieldRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
