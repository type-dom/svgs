...
export class FlFlagPrideProgressFilledSvg extends TypeSvgSvg {
  ...
  constructor(params: SvgProps = {}) {
    ...
    path6.setData("M11 7.5L7 3.5H4.5V11.5H7L11 7.5Z");
    this.addChild(path6);
    const path7 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path7.setData("M9.5 7.5L5.5 3.5H3V11.5H5.5L9.5 7.5Z");
    this.addChild(path7);
    const path8 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path8.setData("M8 7.5L4 3.5H3.5V11.5H4L8 7.5Z");
    this.addChild(path8);
    const path9 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path9.setData("M6.5 7.5L3.5 4.5V10.5L6.5 7.5Z");
    this.addChild(path9);
