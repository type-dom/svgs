...
export class FlImageFilledSvg extends TypeSvgSvg {
  className: 'FlImageFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlImageFilledSvg';
    this.attr.addObj({
      name: 'FlImageFilledSvg',
      title: 'FlImageFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
