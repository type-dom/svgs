...
export class FlSubtractSquareMultipleRegularSvg extends TypeSvgSvg {
  className: 'FlSubtractSquareMultipleRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlSubtractSquareMultipleRegularSvg';
    this.attr.addObj({
      name: 'FlSubtractSquareMultipleRegularSvg',
      title: 'FlSubtractSquareMultipleRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
