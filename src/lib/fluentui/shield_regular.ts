...
export class FlShieldRegularSvg extends TypeSvgSvg {
  className: 'FlShieldRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlShieldRegularSvg';
    this.attr.addObj({
      name: 'FlShieldRegularSvg',
      title: 'FlShieldRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
