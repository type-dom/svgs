...
export class FlChatEmptyRegularSvg extends TypeSvgSvg {
  className: 'FlChatEmptyRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlChatEmptyRegularSvg';
    this.attr.addObj({
      name: 'FlChatEmptyRegularSvg',
      title: 'FlChatEmptyRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
