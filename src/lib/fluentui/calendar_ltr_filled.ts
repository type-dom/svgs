...
export class FlCalendarLtrFilledSvg extends TypeSvgSvg {
  className: 'FlCalendarLtrFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCalendarLtrFilledSvg';
    this.attr.addObj({
      name: 'FlCalendarLtrFilledSvg',
      title: 'FlCalendarLtrFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
