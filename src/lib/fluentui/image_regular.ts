...
export class FlImageRegularSvg extends TypeSvgSvg {
  className: 'FlImageRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlImageRegularSvg';
    this.attr.addObj({
      name: 'FlImageRegularSvg',
      title: 'FlImageRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
