...
export class FlHeadphonesSoundWaveFilledSvg extends TypeSvgSvg {
  className: 'FlHeadphonesSoundWaveFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlHeadphonesSoundWaveFilledSvg';
    this.attr.addObj({
      name: 'FlHeadphonesSoundWaveFilledSvg',
      title: 'FlHeadphonesSoundWaveFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
