...
export class FlTextBulletListSquareEditRegularSvg extends TypeSvgSvg {
  className: 'FlTextBulletListSquareEditRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextBulletListSquareEditRegularSvg';
    this.attr.addObj({
      name: 'FlTextBulletListSquareEditRegularSvg',
      title: 'FlTextBulletListSquareEditRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
