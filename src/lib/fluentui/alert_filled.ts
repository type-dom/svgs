...
export class FlAlertFilledSvg extends TypeSvgSvg {
  className: 'FlAlertFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlAlertFilledSvg';
    this.attr.addObj({
      name: 'FlAlertFilledSvg',
      title: 'FlAlertFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
