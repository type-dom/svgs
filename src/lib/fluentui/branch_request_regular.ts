...
export class FlBranchRequestRegularSvg extends TypeSvgSvg {
  className: 'FlBranchRequestRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlBranchRequestRegularSvg';
    this.attr.addObj({
      name: 'FlBranchRequestRegularSvg',
      title: 'FlBranchRequestRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
