...
export class FlPersonFeedbackRegularSvg extends TypeSvgSvg {
  className: 'FlPersonFeedbackRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPersonFeedbackRegularSvg';
    this.attr.addObj({
      name: 'FlPersonFeedbackRegularSvg',
      title: 'FlPersonFeedbackRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
