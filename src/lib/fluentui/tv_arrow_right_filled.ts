...
export class FlTvArrowRightFilledSvg extends TypeSvgSvg {
  className: 'FlTvArrowRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTvArrowRightFilledSvg';
    this.attr.addObj({
      name: 'FlTvArrowRightFilledSvg',
      title: 'FlTvArrowRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
