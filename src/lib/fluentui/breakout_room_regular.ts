...
export class FlBreakoutRoomRegularSvg extends TypeSvgSvg {
  className: 'FlBreakoutRoomRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlBreakoutRoomRegularSvg';
    this.attr.addObj({
      name: 'FlBreakoutRoomRegularSvg',
      title: 'FlBreakoutRoomRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
