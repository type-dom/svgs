...
export class FlArrowUndoFilledSvg extends TypeSvgSvg {
  className: 'FlArrowUndoFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowUndoFilledSvg';
    this.attr.addObj({
      name: 'FlArrowUndoFilledSvg',
      title: 'FlArrowUndoFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
