...
export class FlLineHorizontal3RegularSvg extends TypeSvgSvg {
  className: 'FlLineHorizontal3RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlLineHorizontal3RegularSvg';
    this.attr.addObj({
      name: 'FlLineHorizontal3RegularSvg',
      title: 'FlLineHorizontal3RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
