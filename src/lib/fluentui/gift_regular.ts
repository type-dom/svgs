...
export class FlGiftRegularSvg extends TypeSvgSvg {
  className: 'FlGiftRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlGiftRegularSvg';
    this.attr.addObj({
      name: 'FlGiftRegularSvg',
      title: 'FlGiftRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
