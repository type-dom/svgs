...
export class FlPanelBottomContractRegularSvg extends TypeSvgSvg {
  className: 'FlPanelBottomContractRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPanelBottomContractRegularSvg';
    this.attr.addObj({
      name: 'FlPanelBottomContractRegularSvg',
      title: 'FlPanelBottomContractRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
