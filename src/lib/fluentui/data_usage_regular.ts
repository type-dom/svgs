...
export class FlDataUsageRegularSvg extends TypeSvgSvg {
  className: 'FlDataUsageRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDataUsageRegularSvg';
    this.attr.addObj({
      name: 'FlDataUsageRegularSvg',
      title: 'FlDataUsageRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
