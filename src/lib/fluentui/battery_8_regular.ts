...
export class FlBattery8RegularSvg extends TypeSvgSvg {
  className: 'FlBattery8RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlBattery8RegularSvg';
    this.attr.addObj({
      name: 'FlBattery8RegularSvg',
      title: 'FlBattery8RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
