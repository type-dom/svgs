...
export class FlTableResizeRowRegularSvg extends TypeSvgSvg {
  className: 'FlTableResizeRowRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTableResizeRowRegularSvg';
    this.attr.addObj({
      name: 'FlTableResizeRowRegularSvg',
      title: 'FlTableResizeRowRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
