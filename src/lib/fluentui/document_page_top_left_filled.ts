...
export class FlDocumentPageTopLeftFilledSvg extends TypeSvgSvg {
  className: 'FlDocumentPageTopLeftFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDocumentPageTopLeftFilledSvg';
    this.attr.addObj({
      name: 'FlDocumentPageTopLeftFilledSvg',
      title: 'FlDocumentPageTopLeftFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
