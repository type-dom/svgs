...
export class FlBroomRegularSvg extends TypeSvgSvg {
  className: 'FlBroomRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlBroomRegularSvg';
    this.attr.addObj({
      name: 'FlBroomRegularSvg',
      title: 'FlBroomRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
