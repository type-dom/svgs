...
export class FlCalendarTodayFilledSvg extends TypeSvgSvg {
  className: 'FlCalendarTodayFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCalendarTodayFilledSvg';
    this.attr.addObj({
      name: 'FlCalendarTodayFilledSvg',
      title: 'FlCalendarTodayFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
