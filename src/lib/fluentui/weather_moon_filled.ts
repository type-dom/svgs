...
export class FlWeatherMoonFilledSvg extends TypeSvgSvg {
  className: 'FlWeatherMoonFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlWeatherMoonFilledSvg';
    this.attr.addObj({
      name: 'FlWeatherMoonFilledSvg',
      title: 'FlWeatherMoonFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
