...
export class FlDocumentTableSearchFilledSvg extends TypeSvgSvg {
  className: 'FlDocumentTableSearchFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDocumentTableSearchFilledSvg';
    this.attr.addObj({
      name: 'FlDocumentTableSearchFilledSvg',
      title: 'FlDocumentTableSearchFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
