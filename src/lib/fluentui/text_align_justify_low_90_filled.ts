...
export class FlTextAlignJustifyLow90FilledSvg extends TypeSvgSvg {
  className: 'FlTextAlignJustifyLow90FilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTextAlignJustifyLow90FilledSvg';
    this.attr.addObj({
      name: 'FlTextAlignJustifyLow90FilledSvg',
      title: 'FlTextAlignJustifyLow90FilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
