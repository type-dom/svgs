...
export class FlMobileOptimizedRegularSvg extends TypeSvgSvg {
  className: 'FlMobileOptimizedRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlMobileOptimizedRegularSvg';
    this.attr.addObj({
      name: 'FlMobileOptimizedRegularSvg',
      title: 'FlMobileOptimizedRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
