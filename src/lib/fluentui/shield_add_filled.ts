...
export class FlShieldAddFilledSvg extends TypeSvgSvg {
  className: 'FlShieldAddFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlShieldAddFilledSvg';
    this.attr.addObj({
      name: 'FlShieldAddFilledSvg',
      title: 'FlShieldAddFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
