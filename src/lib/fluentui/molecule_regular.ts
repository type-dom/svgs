...
export class FlMoleculeRegularSvg extends TypeSvgSvg {
  className: 'FlMoleculeRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlMoleculeRegularSvg';
    this.attr.addObj({
      name: 'FlMoleculeRegularSvg',
      title: 'FlMoleculeRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
