...
export class FlBookDismissFilledSvg extends TypeSvgSvg {
  className: 'FlBookDismissFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBookDismissFilledSvg';
    this.attr.addObj({
      name: 'FlBookDismissFilledSvg',
      title: 'FlBookDismissFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
