...
export class FlFilterDismissFilledSvg extends TypeSvgSvg {
  className: 'FlFilterDismissFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlFilterDismissFilledSvg';
    this.attr.addObj({
      name: 'FlFilterDismissFilledSvg',
      title: 'FlFilterDismissFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
