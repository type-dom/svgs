...
export class FlSignOutFilledSvg extends TypeSvgSvg {
  className: 'FlSignOutFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlSignOutFilledSvg';
    this.attr.addObj({
      name: 'FlSignOutFilledSvg',
      title: 'FlSignOutFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
