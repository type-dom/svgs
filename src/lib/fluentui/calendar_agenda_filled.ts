...
export class FlCalendarAgendaFilledSvg extends TypeSvgSvg {
  className: 'FlCalendarAgendaFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCalendarAgendaFilledSvg';
    this.attr.addObj({
      name: 'FlCalendarAgendaFilledSvg',
      title: 'FlCalendarAgendaFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
