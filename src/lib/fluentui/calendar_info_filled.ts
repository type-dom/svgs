...
export class FlCalendarInfoFilledSvg extends TypeSvgSvg {
  className: 'FlCalendarInfoFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCalendarInfoFilledSvg';
    this.attr.addObj({
      name: 'FlCalendarInfoFilledSvg',
      title: 'FlCalendarInfoFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
