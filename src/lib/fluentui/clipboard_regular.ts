...
export class FlClipboardRegularSvg extends TypeSvgSvg {
  className: 'FlClipboardRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlClipboardRegularSvg';
    this.attr.addObj({
      name: 'FlClipboardRegularSvg',
      title: 'FlClipboardRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
