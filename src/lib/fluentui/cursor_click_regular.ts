...
export class FlCursorClickRegularSvg extends TypeSvgSvg {
  className: 'FlCursorClickRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCursorClickRegularSvg';
    this.attr.addObj({
      name: 'FlCursorClickRegularSvg',
      title: 'FlCursorClickRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
