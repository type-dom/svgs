...
export class FlLinkFilledSvg extends TypeSvgSvg {
  className: 'FlLinkFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlLinkFilledSvg';
    this.attr.addObj({
      name: 'FlLinkFilledSvg',
      title: 'FlLinkFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
