...
export class FlComposeFilledSvg extends TypeSvgSvg {
  className: 'FlComposeFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlComposeFilledSvg';
    this.attr.addObj({
      name: 'FlComposeFilledSvg',
      title: 'FlComposeFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
