...
export class FlMergeFilledSvg extends TypeSvgSvg {
  className: 'FlMergeFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlMergeFilledSvg';
    this.attr.addObj({
      name: 'FlMergeFilledSvg',
      title: 'FlMergeFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
