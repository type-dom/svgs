...
export class FlBookAddRegularSvg extends TypeSvgSvg {
  className: 'FlBookAddRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlBookAddRegularSvg';
    this.attr.addObj({
      name: 'FlBookAddRegularSvg',
      title: 'FlBookAddRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
