...
export class FlBorderOutsideFilledSvg extends TypeSvgSvg {
  className: 'FlBorderOutsideFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBorderOutsideFilledSvg';
    this.attr.addObj({
      name: 'FlBorderOutsideFilledSvg',
      title: 'FlBorderOutsideFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
