...
export class FlOptionsRegularSvg extends TypeSvgSvg {
  className: 'FlOptionsRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlOptionsRegularSvg';
    this.attr.addObj({
      name: 'FlOptionsRegularSvg',
      title: 'FlOptionsRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
