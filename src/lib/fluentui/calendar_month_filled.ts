...
export class FlCalendarMonthFilledSvg extends TypeSvgSvg {
  className: 'FlCalendarMonthFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCalendarMonthFilledSvg';
    this.attr.addObj({
      name: 'FlCalendarMonthFilledSvg',
      title: 'FlCalendarMonthFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
