...
export class FlAutosumFilledSvg extends TypeSvgSvg {
  className: 'FlAutosumFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlAutosumFilledSvg';
    this.attr.addObj({
      name: 'FlAutosumFilledSvg',
      title: 'FlAutosumFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
