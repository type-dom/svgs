...
export class FlHomeAddFilledSvg extends TypeSvgSvg {
  className: 'FlHomeAddFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlHomeAddFilledSvg';
    this.attr.addObj({
      name: 'FlHomeAddFilledSvg',
      title: 'FlHomeAddFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
