...
export class FlShieldKeyholeRegularSvg extends TypeSvgSvg {
  className: 'FlShieldKeyholeRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlShieldKeyholeRegularSvg';
    this.attr.addObj({
      name: 'FlShieldKeyholeRegularSvg',
      title: 'FlShieldKeyholeRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
