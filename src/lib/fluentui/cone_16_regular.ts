...
export class FlCone16RegularSvg extends TypeSvgSvg {
  className: 'FlCone16RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCone16RegularSvg';
    this.attr.addObj({
      name: 'FlCone16RegularSvg',
      title: 'FlCone16RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 16 16',
    });
