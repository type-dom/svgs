...
export class FlPersonArrowRightFilledSvg extends TypeSvgSvg {
  className: 'FlPersonArrowRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPersonArrowRightFilledSvg';
    this.attr.addObj({
      name: 'FlPersonArrowRightFilledSvg',
      title: 'FlPersonArrowRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
