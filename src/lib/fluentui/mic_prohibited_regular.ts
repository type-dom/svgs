...
export class FlMicProhibitedRegularSvg extends TypeSvgSvg {
  className: 'FlMicProhibitedRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlMicProhibitedRegularSvg';
    this.attr.addObj({
      name: 'FlMicProhibitedRegularSvg',
      title: 'FlMicProhibitedRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
