...
export class FlTextGrammarErrorRegularSvg extends TypeSvgSvg {
  className: 'FlTextGrammarErrorRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTextGrammarErrorRegularSvg';
    this.attr.addObj({
      name: 'FlTextGrammarErrorRegularSvg',
      title: 'FlTextGrammarErrorRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
