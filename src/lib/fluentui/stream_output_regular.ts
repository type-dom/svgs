...
export class FlStreamOutputRegularSvg extends TypeSvgSvg {
  className: 'FlStreamOutputRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlStreamOutputRegularSvg';
    this.attr.addObj({
      name: 'FlStreamOutputRegularSvg',
      title: 'FlStreamOutputRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
