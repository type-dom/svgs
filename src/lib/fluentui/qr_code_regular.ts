...
export class FlQrCodeRegularSvg extends TypeSvgSvg {
  className: 'FlQrCodeRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlQrCodeRegularSvg';
    this.attr.addObj({
      name: 'FlQrCodeRegularSvg',
      title: 'FlQrCodeRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
