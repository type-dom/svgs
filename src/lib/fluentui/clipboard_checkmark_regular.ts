...
export class FlClipboardCheckmarkRegularSvg extends TypeSvgSvg {
  className: 'FlClipboardCheckmarkRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlClipboardCheckmarkRegularSvg';
    this.attr.addObj({
      name: 'FlClipboardCheckmarkRegularSvg',
      title: 'FlClipboardCheckmarkRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
