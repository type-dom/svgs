...
export class FlImageAddRegularSvg extends TypeSvgSvg {
  className: 'FlImageAddRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlImageAddRegularSvg';
    this.attr.addObj({
      name: 'FlImageAddRegularSvg',
      title: 'FlImageAddRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
