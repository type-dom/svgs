...
export class FlChatMoreColorSvg extends TypeSvgSvg {
  className: 'FlChatMoreColorSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlChatMoreColorSvg';
    this.attr.addObj({
      name: 'FlChatMoreColorSvg',
      title: 'FlChatMoreColorSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
