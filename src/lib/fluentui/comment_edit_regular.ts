...
export class FlCommentEditRegularSvg extends TypeSvgSvg {
  className: 'FlCommentEditRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCommentEditRegularSvg';
    this.attr.addObj({
      name: 'FlCommentEditRegularSvg',
      title: 'FlCommentEditRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
