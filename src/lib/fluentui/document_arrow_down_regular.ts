...
export class FlDocumentArrowDownRegularSvg extends TypeSvgSvg {
  className: 'FlDocumentArrowDownRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDocumentArrowDownRegularSvg';
    this.attr.addObj({
      name: 'FlDocumentArrowDownRegularSvg',
      title: 'FlDocumentArrowDownRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
