...
export class FlNotebookRegularSvg extends TypeSvgSvg {
  className: 'FlNotebookRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlNotebookRegularSvg';
    this.attr.addObj({
      name: 'FlNotebookRegularSvg',
      title: 'FlNotebookRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
