...
export class FlPanelLeftExpandRegularSvg extends TypeSvgSvg {
  className: 'FlPanelLeftExpandRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPanelLeftExpandRegularSvg';
    this.attr.addObj({
      name: 'FlPanelLeftExpandRegularSvg',
      title: 'FlPanelLeftExpandRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
