...
export class FlDocumentRibbonFilledSvg extends TypeSvgSvg {
  className: 'FlDocumentRibbonFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDocumentRibbonFilledSvg';
    this.attr.addObj({
      name: 'FlDocumentRibbonFilledSvg',
      title: 'FlDocumentRibbonFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
