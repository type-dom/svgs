...
export class FlMentionRegularSvg extends TypeSvgSvg {
  className: 'FlMentionRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlMentionRegularSvg';
    this.attr.addObj({
      name: 'FlMentionRegularSvg',
      title: 'FlMentionRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
