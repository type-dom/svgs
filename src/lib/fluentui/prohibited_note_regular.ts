...
export class FlProhibitedNoteRegularSvg extends TypeSvgSvg {
  className: 'FlProhibitedNoteRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlProhibitedNoteRegularSvg';
    this.attr.addObj({
      name: 'FlProhibitedNoteRegularSvg',
      title: 'FlProhibitedNoteRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
