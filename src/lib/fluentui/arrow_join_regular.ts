...
export class FlArrowJoinRegularSvg extends TypeSvgSvg {
  className: 'FlArrowJoinRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowJoinRegularSvg';
    this.attr.addObj({
      name: 'FlArrowJoinRegularSvg',
      title: 'FlArrowJoinRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
