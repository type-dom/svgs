...
export class FlStethoscopeRegularSvg extends TypeSvgSvg {
  className: 'FlStethoscopeRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlStethoscopeRegularSvg';
    this.attr.addObj({
      name: 'FlStethoscopeRegularSvg',
      title: 'FlStethoscopeRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
