...
export class FlDataAreaFilledSvg extends TypeSvgSvg {
  className: 'FlDataAreaFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDataAreaFilledSvg';
    this.attr.addObj({
      name: 'FlDataAreaFilledSvg',
      title: 'FlDataAreaFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
