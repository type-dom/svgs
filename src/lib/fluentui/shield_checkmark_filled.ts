...
export class FlShieldCheckmarkFilledSvg extends TypeSvgSvg {
  className: 'FlShieldCheckmarkFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlShieldCheckmarkFilledSvg';
    this.attr.addObj({
      name: 'FlShieldCheckmarkFilledSvg',
      title: 'FlShieldCheckmarkFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
