...
export class FlArrowAutofitHeightFilledSvg extends TypeSvgSvg {
  className: 'FlArrowAutofitHeightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowAutofitHeightFilledSvg';
    this.attr.addObj({
      name: 'FlArrowAutofitHeightFilledSvg',
      title: 'FlArrowAutofitHeightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
