...
export class FlDoorArrowLeftFilledSvg extends TypeSvgSvg {
  className: 'FlDoorArrowLeftFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDoorArrowLeftFilledSvg';
    this.attr.addObj({
      name: 'FlDoorArrowLeftFilledSvg',
      title: 'FlDoorArrowLeftFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
