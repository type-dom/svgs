...
export class FlShareAndroidRegularSvg extends TypeSvgSvg {
  className: 'FlShareAndroidRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlShareAndroidRegularSvg';
    this.attr.addObj({
      name: 'FlShareAndroidRegularSvg',
      title: 'FlShareAndroidRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
