...
export class FlTextAsteriskRegularSvg extends TypeSvgSvg {
  className: 'FlTextAsteriskRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTextAsteriskRegularSvg';
    this.attr.addObj({
      name: 'FlTextAsteriskRegularSvg',
      title: 'FlTextAsteriskRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
