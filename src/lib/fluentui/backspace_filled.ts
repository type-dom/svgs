...
export class FlBackspaceFilledSvg extends TypeSvgSvg {
  className: 'FlBackspaceFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlBackspaceFilledSvg';
    this.attr.addObj({
      name: 'FlBackspaceFilledSvg',
      title: 'FlBackspaceFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
