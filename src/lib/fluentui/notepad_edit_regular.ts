...
export class FlNotepadEditRegularSvg extends TypeSvgSvg {
  className: 'FlNotepadEditRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlNotepadEditRegularSvg';
    this.attr.addObj({
      name: 'FlNotepadEditRegularSvg',
      title: 'FlNotepadEditRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
