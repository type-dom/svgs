...
export class FlChevronDoubleDownFilledSvg extends TypeSvgSvg {
  className: 'FlChevronDoubleDownFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlChevronDoubleDownFilledSvg';
    this.attr.addObj({
      name: 'FlChevronDoubleDownFilledSvg',
      title: 'FlChevronDoubleDownFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
