...
export class FlTextIndentIncreaseRtl90RegularSvg extends TypeSvgSvg {
  className: 'FlTextIndentIncreaseRtl90RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTextIndentIncreaseRtl90RegularSvg';
    this.attr.addObj({
      name: 'FlTextIndentIncreaseRtl90RegularSvg',
      title: 'FlTextIndentIncreaseRtl90RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
