...
export class FlBuildingShopRegularSvg extends TypeSvgSvg {
  className: 'FlBuildingShopRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBuildingShopRegularSvg';
    this.attr.addObj({
      name: 'FlBuildingShopRegularSvg',
      title: 'FlBuildingShopRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
