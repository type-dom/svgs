...
export class FlCommentNoteFilledSvg extends TypeSvgSvg {
  className: 'FlCommentNoteFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCommentNoteFilledSvg';
    this.attr.addObj({
      name: 'FlCommentNoteFilledSvg',
      title: 'FlCommentNoteFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
