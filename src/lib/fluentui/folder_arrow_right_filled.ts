...
export class FlFolderArrowRightFilledSvg extends TypeSvgSvg {
  className: 'FlFolderArrowRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlFolderArrowRightFilledSvg';
    this.attr.addObj({
      name: 'FlFolderArrowRightFilledSvg',
      title: 'FlFolderArrowRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
