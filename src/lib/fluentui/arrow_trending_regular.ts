...
export class FlArrowTrendingRegularSvg extends TypeSvgSvg {
  className: 'FlArrowTrendingRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowTrendingRegularSvg';
    this.attr.addObj({
      name: 'FlArrowTrendingRegularSvg',
      title: 'FlArrowTrendingRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
