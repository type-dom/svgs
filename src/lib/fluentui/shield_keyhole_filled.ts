...
export class FlShieldKeyholeFilledSvg extends TypeSvgSvg {
  className: 'FlShieldKeyholeFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlShieldKeyholeFilledSvg';
    this.attr.addObj({
      name: 'FlShieldKeyholeFilledSvg',
      title: 'FlShieldKeyholeFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
