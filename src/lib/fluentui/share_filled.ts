...
export class FlShareFilledSvg extends TypeSvgSvg {
  className: 'FlShareFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlShareFilledSvg';
    this.attr.addObj({
      name: 'FlShareFilledSvg',
      title: 'FlShareFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
