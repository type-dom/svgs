...
export class FlCircleOffRegularSvg extends TypeSvgSvg {
  className: 'FlCircleOffRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCircleOffRegularSvg';
    this.attr.addObj({
      name: 'FlCircleOffRegularSvg',
      title: 'FlCircleOffRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
