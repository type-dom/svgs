...
export class FlHeadsetColorSvg extends TypeSvgSvg {
  ...
  constructor(params: TypeProps = {}) {
    ...
    path0.setData(
      'M6 12V14C6 14.5523 6.44772 15 7 15H9V17H7C5.34315 17 4 15.6569 4 14V12H6Z',
    );
    this.addChild(path0);
    ...
    path3.setData(
      'M6 8H7C7.55228 8 8 8.44772 8 9V12C8 12.5523 7.55228 13 7 13H6L5 10.5L6 8Z',
    );
    this.addChild(path3);
    ...
    path6.setData(
      'M16 8H14V13C15.1046 13 16 12.1046 16 11V8Z',
    );
    this.addChild(path6);
