...
export class FlPhoneDismissRegularSvg extends TypeSvgSvg {
  className: 'FlPhoneDismissRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPhoneDismissRegularSvg';
    this.attr.addObj({
      name: 'FlPhoneDismissRegularSvg',
      title: 'FlPhoneDismissRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
