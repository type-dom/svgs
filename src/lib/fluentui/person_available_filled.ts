...
export class FlPersonAvailableFilledSvg extends TypeSvgSvg {
  className: 'FlPersonAvailableFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPersonAvailableFilledSvg';
    this.attr.addObj({
      name: 'FlPersonAvailableFilledSvg',
      title: 'FlPersonAvailableFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
