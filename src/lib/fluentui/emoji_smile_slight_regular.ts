...
export class FlEmojiSmileSlightRegularSvg extends TypeSvgSvg {
  className: 'FlEmojiSmileSlightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlEmojiSmileSlightRegularSvg';
    this.attr.addObj({
      name: 'FlEmojiSmileSlightRegularSvg',
      title: 'FlEmojiSmileSlightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
