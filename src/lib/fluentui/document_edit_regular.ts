...
export class FlDocumentEditRegularSvg extends TypeSvgSvg {
  className: 'FlDocumentEditRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDocumentEditRegularSvg';
    this.attr.addObj({
      name: 'FlDocumentEditRegularSvg',
      title: 'FlDocumentEditRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
