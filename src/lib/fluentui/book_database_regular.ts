...
export class FlBookDatabaseRegularSvg extends TypeSvgSvg {
  className: 'FlBookDatabaseRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBookDatabaseRegularSvg';
    this.attr.addObj({
      name: 'FlBookDatabaseRegularSvg',
      title: 'FlBookDatabaseRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
