...
export class FlArrowResetRegularSvg extends TypeSvgSvg {
  className: 'FlArrowResetRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowResetRegularSvg';
    this.attr.addObj({
      name: 'FlArrowResetRegularSvg',
      title: 'FlArrowResetRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
