...
export class FlHistoryRegularSvg extends TypeSvgSvg {
  className: 'FlHistoryRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlHistoryRegularSvg';
    this.attr.addObj({
      name: 'FlHistoryRegularSvg',
      title: 'FlHistoryRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
