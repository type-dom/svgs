...
export class FlPersonArrowLeftFilledSvg extends TypeSvgSvg {
  className: 'FlPersonArrowLeftFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPersonArrowLeftFilledSvg';
    this.attr.addObj({
      name: 'FlPersonArrowLeftFilledSvg',
      title: 'FlPersonArrowLeftFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
