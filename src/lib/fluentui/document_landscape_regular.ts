...
export class FlDocumentLandscapeRegularSvg extends TypeSvgSvg {
  className: 'FlDocumentLandscapeRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDocumentLandscapeRegularSvg';
    this.attr.addObj({
      name: 'FlDocumentLandscapeRegularSvg',
      title: 'FlDocumentLandscapeRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
