...
export class FlShieldCheckmarkRegularSvg extends TypeSvgSvg {
  className: 'FlShieldCheckmarkRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlShieldCheckmarkRegularSvg';
    this.attr.addObj({
      name: 'FlShieldCheckmarkRegularSvg',
      title: 'FlShieldCheckmarkRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
