...
export class FlTextColumnWideRegularSvg extends TypeSvgSvg {
  className: 'FlTextColumnWideRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTextColumnWideRegularSvg';
    this.attr.addObj({
      name: 'FlTextColumnWideRegularSvg',
      title: 'FlTextColumnWideRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
