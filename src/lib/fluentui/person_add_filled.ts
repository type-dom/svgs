...
export class FlPersonAddFilledSvg extends TypeSvgSvg {
  className: 'FlPersonAddFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPersonAddFilledSvg';
    this.attr.addObj({
      name: 'FlPersonAddFilledSvg',
      title: 'FlPersonAddFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
