...
export class FlBookCompassFilledSvg extends TypeSvgSvg {
  className: 'FlBookCompassFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBookCompassFilledSvg';
    this.attr.addObj({
      name: 'FlBookCompassFilledSvg',
      title: 'FlBookCompassFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
