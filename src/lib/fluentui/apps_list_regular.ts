...
export class FlAppsListRegularSvg extends TypeSvgSvg {
  className: 'FlAppsListRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlAppsListRegularSvg';
    this.attr.addObj({
      name: 'FlAppsListRegularSvg',
      title: 'FlAppsListRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
