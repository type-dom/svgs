...
export class FlTemperatureRegularSvg extends TypeSvgSvg {
  className: 'FlTemperatureRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTemperatureRegularSvg';
    this.attr.addObj({
      name: 'FlTemperatureRegularSvg',
      title: 'FlTemperatureRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
