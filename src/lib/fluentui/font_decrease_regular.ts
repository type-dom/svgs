...
export class FlFontDecreaseRegularSvg extends TypeSvgSvg {
  className: 'FlFontDecreaseRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlFontDecreaseRegularSvg';
    this.attr.addObj({
      name: 'FlFontDecreaseRegularSvg',
      title: 'FlFontDecreaseRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
