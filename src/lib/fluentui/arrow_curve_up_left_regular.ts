...
export class FlArrowCurveUpLeftRegularSvg extends TypeSvgSvg {
  className: 'FlArrowCurveUpLeftRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowCurveUpLeftRegularSvg';
    this.attr.addObj({
      name: 'FlArrowCurveUpLeftRegularSvg',
      title: 'FlArrowCurveUpLeftRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
