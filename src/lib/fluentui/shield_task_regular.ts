...
export class FlShieldTaskRegularSvg extends TypeSvgSvg {
  className: 'FlShieldTaskRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlShieldTaskRegularSvg';
    this.attr.addObj({
      name: 'FlShieldTaskRegularSvg',
      title: 'FlShieldTaskRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
