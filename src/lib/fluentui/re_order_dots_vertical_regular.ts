...
export class FlReOrderDotsVerticalRegularSvg extends TypeSvgSvg {
  className: 'FlReOrderDotsVerticalRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlReOrderDotsVerticalRegularSvg';
    this.attr.addObj({
      name: 'FlReOrderDotsVerticalRegularSvg',
      title: 'FlReOrderDotsVerticalRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
