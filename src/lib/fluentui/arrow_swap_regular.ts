...
export class FlArrowSwapRegularSvg extends TypeSvgSvg {
  className: 'FlArrowSwapRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowSwapRegularSvg';
    this.attr.addObj({
      name: 'FlArrowSwapRegularSvg',
      title: 'FlArrowSwapRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
