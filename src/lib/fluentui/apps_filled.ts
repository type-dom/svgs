...
export class FlAppsFilledSvg extends TypeSvgSvg {
  className: 'FlAppsFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlAppsFilledSvg';
    this.attr.addObj({
      name: 'FlAppsFilledSvg',
      title: 'FlAppsFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
