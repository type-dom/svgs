...
export class FlCalendarArrowRightFilledSvg extends TypeSvgSvg {
  className: 'FlCalendarArrowRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCalendarArrowRightFilledSvg';
    this.attr.addObj({
      name: 'FlCalendarArrowRightFilledSvg',
      title: 'FlCalendarArrowRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
