...
export class FlTextGrammarCheckmarkRegularSvg extends TypeSvgSvg {
  className: 'FlTextGrammarCheckmarkRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextGrammarCheckmarkRegularSvg';
    this.attr.addObj({
      name: 'FlTextGrammarCheckmarkRegularSvg',
      title: 'FlTextGrammarCheckmarkRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
