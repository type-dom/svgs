...
export class FlPersonInfoFilledSvg extends TypeSvgSvg {
  className: 'FlPersonInfoFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPersonInfoFilledSvg';
    this.attr.addObj({
      name: 'FlPersonInfoFilledSvg',
      title: 'FlPersonInfoFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
