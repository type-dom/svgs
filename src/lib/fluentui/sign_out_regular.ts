...
export class FlSignOutRegularSvg extends TypeSvgSvg {
  className: 'FlSignOutRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlSignOutRegularSvg';
    this.attr.addObj({
      name: 'FlSignOutRegularSvg',
      title: 'FlSignOutRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
