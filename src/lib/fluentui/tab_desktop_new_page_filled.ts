...
export class FlTabDesktopNewPageFilledSvg extends TypeSvgSvg {
  className: 'FlTabDesktopNewPageFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTabDesktopNewPageFilledSvg';
    this.attr.addObj({
      name: 'FlTabDesktopNewPageFilledSvg',
      title: 'FlTabDesktopNewPageFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
