...
export class FlPageFitFilledSvg extends TypeSvgSvg {
  className: 'FlPageFitFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPageFitFilledSvg';
    this.attr.addObj({
      name: 'FlPageFitFilledSvg',
      title: 'FlPageFitFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
