...
export class FlPanelBottomExpandRegularSvg extends TypeSvgSvg {
  className: 'FlPanelBottomExpandRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPanelBottomExpandRegularSvg';
    this.attr.addObj({
      name: 'FlPanelBottomExpandRegularSvg',
      title: 'FlPanelBottomExpandRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
