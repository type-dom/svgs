...
export class FlTextIndentIncreaseRotate270RegularSvg extends TypeSvgSvg {
  className: 'FlTextIndentIncreaseRotate270RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextIndentIncreaseRotate270RegularSvg';
    this.attr.addObj({
      name: 'FlTextIndentIncreaseRotate270RegularSvg',
      title: 'FlTextIndentIncreaseRotate270RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
