...
export class FlDismissCircleFilledSvg extends TypeSvgSvg {
  className: 'FlDismissCircleFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDismissCircleFilledSvg';
    this.attr.addObj({
      name: 'FlDismissCircleFilledSvg',
      title: 'FlDismissCircleFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
