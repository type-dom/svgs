...
export class FlRatioOneToOneRegularSvg extends TypeSvgSvg {
  className: 'FlRatioOneToOneRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlRatioOneToOneRegularSvg';
    this.attr.addObj({
      name: 'FlRatioOneToOneRegularSvg',
      title: 'FlRatioOneToOneRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
