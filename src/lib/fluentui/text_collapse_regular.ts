...
export class FlTextCollapseRegularSvg extends TypeSvgSvg {
  className: 'FlTextCollapseRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextCollapseRegularSvg';
    this.attr.addObj({
      name: 'FlTextCollapseRegularSvg',
      title: 'FlTextCollapseRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
