...
export class FlPersonArrowBackFilledSvg extends TypeSvgSvg {
  className: 'FlPersonArrowBackFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPersonArrowBackFilledSvg';
    this.attr.addObj({
      name: 'FlPersonArrowBackFilledSvg',
      title: 'FlPersonArrowBackFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
