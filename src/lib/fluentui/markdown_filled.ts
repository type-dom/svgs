...
export class FlMarkdownFilledSvg extends TypeSvgSvg {
  className: 'FlMarkdownFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlMarkdownFilledSvg';
    this.attr.addObj({
      name: 'FlMarkdownFilledSvg',
      title: 'FlMarkdownFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
