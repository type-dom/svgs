...
export class FlPanelLeftTextRegularSvg extends TypeSvgSvg {
  className: 'FlPanelLeftTextRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPanelLeftTextRegularSvg';
    this.attr.addObj({
      name: 'FlPanelLeftTextRegularSvg',
      title: 'FlPanelLeftTextRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
