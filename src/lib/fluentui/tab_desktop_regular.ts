...
export class FlTabDesktopRegularSvg extends TypeSvgSvg {
  className: 'FlTabDesktopRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTabDesktopRegularSvg';
    this.attr.addObj({
      name: 'FlTabDesktopRegularSvg',
      title: 'FlTabDesktopRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
