...
export class FlWindowConsoleFilledSvg extends TypeSvgSvg {
  className: 'FlWindowConsoleFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlWindowConsoleFilledSvg';
    this.attr.addObj({
      name: 'FlWindowConsoleFilledSvg',
      title: 'FlWindowConsoleFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
