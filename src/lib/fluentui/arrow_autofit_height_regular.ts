...
export class FlArrowAutofitHeightRegularSvg extends TypeSvgSvg {
  className: 'FlArrowAutofitHeightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowAutofitHeightRegularSvg';
    this.attr.addObj({
      name: 'FlArrowAutofitHeightRegularSvg',
      title: 'FlArrowAutofitHeightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
