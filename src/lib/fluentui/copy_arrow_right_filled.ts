...
export class FlCopyArrowRightFilledSvg extends TypeSvgSvg {
  className: 'FlCopyArrowRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCopyArrowRightFilledSvg';
    this.attr.addObj({
      name: 'FlCopyArrowRightFilledSvg',
      title: 'FlCopyArrowRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
