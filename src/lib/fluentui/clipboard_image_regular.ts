...
export class FlClipboardImageRegularSvg extends TypeSvgSvg {
  className: 'FlClipboardImageRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlClipboardImageRegularSvg';
    this.attr.addObj({
      name: 'FlClipboardImageRegularSvg',
      title: 'FlClipboardImageRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
