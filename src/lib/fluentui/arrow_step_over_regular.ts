...
export class FlArrowStepOverRegularSvg extends TypeSvgSvg {
  className: 'FlArrowStepOverRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowStepOverRegularSvg';
    this.attr.addObj({
      name: 'FlArrowStepOverRegularSvg',
      title: 'FlArrowStepOverRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
