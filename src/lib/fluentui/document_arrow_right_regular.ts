...
export class FlDocumentArrowRightRegularSvg extends TypeSvgSvg {
  className: 'FlDocumentArrowRightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDocumentArrowRightRegularSvg';
    this.attr.addObj({
      name: 'FlDocumentArrowRightRegularSvg',
      title: 'FlDocumentArrowRightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
