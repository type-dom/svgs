...
export class FlFlowRegularSvg extends TypeSvgSvg {
  className: 'FlFlowRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlFlowRegularSvg';
    this.attr.addObj({
      name: 'FlFlowRegularSvg',
      title: 'FlFlowRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
