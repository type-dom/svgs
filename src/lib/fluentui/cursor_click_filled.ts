...
export class FlCursorClickFilledSvg extends TypeSvgSvg {
  className: 'FlCursorClickFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCursorClickFilledSvg';
    this.attr.addObj({
      name: 'FlCursorClickFilledSvg',
      title: 'FlCursorClickFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
