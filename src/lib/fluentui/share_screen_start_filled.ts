...
export class FlShareScreenStartFilledSvg extends TypeSvgSvg {
  className: 'FlShareScreenStartFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlShareScreenStartFilledSvg';
    this.attr.addObj({
      name: 'FlShareScreenStartFilledSvg',
      title: 'FlShareScreenStartFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
