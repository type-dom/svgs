...
export class FlArrowCurveDownRightFilledSvg extends TypeSvgSvg {
  className: 'FlArrowCurveDownRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowCurveDownRightFilledSvg';
    this.attr.addObj({
      name: 'FlArrowCurveDownRightFilledSvg',
      title: 'FlArrowCurveDownRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
