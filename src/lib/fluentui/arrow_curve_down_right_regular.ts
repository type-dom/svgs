...
export class FlArrowCurveDownRightRegularSvg extends TypeSvgSvg {
  className: 'FlArrowCurveDownRightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowCurveDownRightRegularSvg';
    this.attr.addObj({
      name: 'FlArrowCurveDownRightRegularSvg',
      title: 'FlArrowCurveDownRightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
