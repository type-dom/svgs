...
export class FlBriefcaseFilledSvg extends TypeSvgSvg {
  className: 'FlBriefcaseFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBriefcaseFilledSvg';
    this.attr.addObj({
      name: 'FlBriefcaseFilledSvg',
      title: 'FlBriefcaseFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
