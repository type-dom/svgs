...
export class FlCameraSwitchRegularSvg extends TypeSvgSvg {
  className: 'FlCameraSwitchRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCameraSwitchRegularSvg';
    this.attr.addObj({
      name: 'FlCameraSwitchRegularSvg',
      title: 'FlCameraSwitchRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
