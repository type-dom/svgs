...
export class FlTextHeader1RegularSvg extends TypeSvgSvg {
  className: 'FlTextHeader1RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextHeader1RegularSvg';
    this.attr.addObj({
      name: 'FlTextHeader1RegularSvg',
      title: 'FlTextHeader1RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
