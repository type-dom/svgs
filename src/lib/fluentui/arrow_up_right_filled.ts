...
export class FlArrowUpRightFilledSvg extends TypeSvgSvg {
  className: 'FlArrowUpRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowUpRightFilledSvg';
    this.attr.addObj({
      name: 'FlArrowUpRightFilledSvg',
      title: 'FlArrowUpRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
