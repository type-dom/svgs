...
export class FlTextAlignJustifyLow90RegularSvg extends TypeSvgSvg {
  className: 'FlTextAlignJustifyLow90RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTextAlignJustifyLow90RegularSvg';
    this.attr.addObj({
      name: 'FlTextAlignJustifyLow90RegularSvg',
      title: 'FlTextAlignJustifyLow90RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
