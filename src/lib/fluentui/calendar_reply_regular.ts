...
export class FlCalendarReplyRegularSvg extends TypeSvgSvg {
  className: 'FlCalendarReplyRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCalendarReplyRegularSvg';
    this.attr.addObj({
      name: 'FlCalendarReplyRegularSvg',
      title: 'FlCalendarReplyRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
