...
export class FlPersonProhibitedRegularSvg extends TypeSvgSvg {
  className: 'FlPersonProhibitedRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPersonProhibitedRegularSvg';
    this.attr.addObj({
      name: 'FlPersonProhibitedRegularSvg',
      title: 'FlPersonProhibitedRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
