...
export class FlArrowCurveUpRightFilledSvg extends TypeSvgSvg {
  className: 'FlArrowCurveUpRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowCurveUpRightFilledSvg';
    this.attr.addObj({
      name: 'FlArrowCurveUpRightFilledSvg',
      title: 'FlArrowCurveUpRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
