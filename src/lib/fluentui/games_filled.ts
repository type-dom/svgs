...
export class FlGamesFilledSvg extends TypeSvgSvg {
  className: 'FlGamesFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlGamesFilledSvg';
    this.attr.addObj({
      name: 'FlGamesFilledSvg',
      title: 'FlGamesFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
