...
export class FlCopyArrowRightRegularSvg extends TypeSvgSvg {
  className: 'FlCopyArrowRightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCopyArrowRightRegularSvg';
    this.attr.addObj({
      name: 'FlCopyArrowRightRegularSvg',
      title: 'FlCopyArrowRightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
