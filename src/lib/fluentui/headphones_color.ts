...
export class FlHeadphonesColorSvg extends TypeSvgSvg {
  ...
  constructor(params: SvgProps = {}) {
    ...
    path1.setData("M4.5 11H2V16C2 17.1046 2.89543 18 4 18H5V11.5C5 11.2239 4.77614 11 4.5 11Z");
    this.addChild(path1);
    ...
    path3.setData("M7 11H4V18H7C7.55228 18 8 17.5523 8 17V12C8 11.4477 7.55228 11 7 11Z");
    this.addChild(path3);
    const path4 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path4.setData("M13 11H16V18H13C12.4477 18 12 17.5523 12 17V12C12 11.4477 12.4477 11 13 11Z");
    this.addChild(path4);
  }
}
