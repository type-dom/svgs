...
export class FlRulerRegularSvg extends TypeSvgSvg {
  className: 'FlRulerRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlRulerRegularSvg';
    this.attr.addObj({
      name: 'FlRulerRegularSvg',
      title: 'FlRulerRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
