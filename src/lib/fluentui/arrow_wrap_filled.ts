...
export class FlArrowWrapFilledSvg extends TypeSvgSvg {
  className: 'FlArrowWrapFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowWrapFilledSvg';
    this.attr.addObj({
      name: 'FlArrowWrapFilledSvg',
      title: 'FlArrowWrapFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
