...
export class FlPhoneArrowRightFilledSvg extends TypeSvgSvg {
  className: 'FlPhoneArrowRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPhoneArrowRightFilledSvg';
    this.attr.addObj({
      name: 'FlPhoneArrowRightFilledSvg',
      title: 'FlPhoneArrowRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
