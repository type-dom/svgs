...
export class FlTableSearchFilledSvg extends TypeSvgSvg {
  ...
  constructor(params: SvgProps = {}) {
    ...
    path0.setData("M13 17H14.5C15.8807 17 17 15.8807 17 14.5V13H13V17Z");
    this.addChild(path0);
    const path1 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path1.setData("M13 12V8H17V12H13Z");
    this.addChild(path1);
    const path2 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path2.setData("M12 12H8.74394C8.57189 11.5132 8.31846 11.0649 8 10.6713V8H12V12Z");
    this.addChild(path2);
    ...
    path5.setData("M13 7H17V5.5C17 4.11929 15.8807 3 14.5 3H13V7Z");
    this.addChild(path5);
    const path6 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path6.setData("M12 3V7H8V3H12Z");
    this.addChild(path6);
    const path7 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path7.setData("M7 3V7H3V5.5C3 4.11929 4.11929 3 5.5 3H7Z");
    this.addChild(path7);
