...
export class FlTextAlignLeftRegularSvg extends TypeSvgSvg {
  className: 'FlTextAlignLeftRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextAlignLeftRegularSvg';
    this.attr.addObj({
      name: 'FlTextAlignLeftRegularSvg',
      title: 'FlTextAlignLeftRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
