...
export class FlTextBulletListAddRegularSvg extends TypeSvgSvg {
  className: 'FlTextBulletListAddRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextBulletListAddRegularSvg';
    this.attr.addObj({
      name: 'FlTextBulletListAddRegularSvg',
      title: 'FlTextBulletListAddRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
