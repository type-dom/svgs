...
export class FlPersonStarRegularSvg extends TypeSvgSvg {
  className: 'FlPersonStarRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPersonStarRegularSvg';
    this.attr.addObj({
      name: 'FlPersonStarRegularSvg',
      title: 'FlPersonStarRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
