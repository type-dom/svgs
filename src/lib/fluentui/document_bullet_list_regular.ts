...
export class FlDocumentBulletListRegularSvg extends TypeSvgSvg {
  className: 'FlDocumentBulletListRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDocumentBulletListRegularSvg';
    this.attr.addObj({
      name: 'FlDocumentBulletListRegularSvg',
      title: 'FlDocumentBulletListRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
