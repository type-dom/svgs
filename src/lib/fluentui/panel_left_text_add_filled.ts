...
export class FlPanelLeftTextAddFilledSvg extends TypeSvgSvg {
  className: 'FlPanelLeftTextAddFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPanelLeftTextAddFilledSvg';
    this.attr.addObj({
      name: 'FlPanelLeftTextAddFilledSvg',
      title: 'FlPanelLeftTextAddFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
