...
export class FlZoomOutRegularSvg extends TypeSvgSvg {
  className: 'FlZoomOutRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlZoomOutRegularSvg';
    this.attr.addObj({
      name: 'FlZoomOutRegularSvg',
      title: 'FlZoomOutRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
