...
export class FlBookPulseRegularSvg extends TypeSvgSvg {
  className: 'FlBookPulseRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBookPulseRegularSvg';
    this.attr.addObj({
      name: 'FlBookPulseRegularSvg',
      title: 'FlBookPulseRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
