...
export class FlVehicleBusRegularSvg extends TypeSvgSvg {
  className: 'FlVehicleBusRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlVehicleBusRegularSvg';
    this.attr.addObj({
      name: 'FlVehicleBusRegularSvg',
      title: 'FlVehicleBusRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
