...
export class FlMicOffFilledSvg extends TypeSvgSvg {
  className: 'FlMicOffFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlMicOffFilledSvg';
    this.attr.addObj({
      name: 'FlMicOffFilledSvg',
      title: 'FlMicOffFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
