...
export class FlClockRegularSvg extends TypeSvgSvg {
  className: 'FlClockRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlClockRegularSvg';
    this.attr.addObj({
      name: 'FlClockRegularSvg',
      title: 'FlClockRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
