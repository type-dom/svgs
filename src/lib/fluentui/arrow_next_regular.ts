...
export class FlArrowNextRegularSvg extends TypeSvgSvg {
  className: 'FlArrowNextRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowNextRegularSvg';
    this.attr.addObj({
      name: 'FlArrowNextRegularSvg',
      title: 'FlArrowNextRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
