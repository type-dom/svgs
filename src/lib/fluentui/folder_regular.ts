...
export class FlFolderRegularSvg extends TypeSvgSvg {
  className: 'FlFolderRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlFolderRegularSvg';
    this.attr.addObj({
      name: 'FlFolderRegularSvg',
      title: 'FlFolderRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
