...
export class FlPaintBucketRegularSvg extends TypeSvgSvg {
  className: 'FlPaintBucketRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPaintBucketRegularSvg';
    this.attr.addObj({
      name: 'FlPaintBucketRegularSvg',
      title: 'FlPaintBucketRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
