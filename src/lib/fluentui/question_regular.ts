...
export class FlQuestionRegularSvg extends TypeSvgSvg {
  className: 'FlQuestionRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlQuestionRegularSvg';
    this.attr.addObj({
      name: 'FlQuestionRegularSvg',
      title: 'FlQuestionRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
