...
export class FlPanelLeftAddRegularSvg extends TypeSvgSvg {
  className: 'FlPanelLeftAddRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPanelLeftAddRegularSvg';
    this.attr.addObj({
      name: 'FlPanelLeftAddRegularSvg',
      title: 'FlPanelLeftAddRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
