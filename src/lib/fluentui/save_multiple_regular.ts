...
export class FlSaveMultipleRegularSvg extends TypeSvgSvg {
  className: 'FlSaveMultipleRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlSaveMultipleRegularSvg';
    this.attr.addObj({
      name: 'FlSaveMultipleRegularSvg',
      title: 'FlSaveMultipleRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
