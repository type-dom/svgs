...
export class FlDocumentHeaderDismissFilledSvg extends TypeSvgSvg {
  className: 'FlDocumentHeaderDismissFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDocumentHeaderDismissFilledSvg';
    this.attr.addObj({
      name: 'FlDocumentHeaderDismissFilledSvg',
      title: 'FlDocumentHeaderDismissFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
