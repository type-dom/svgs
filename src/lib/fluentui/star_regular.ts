...
export class FlStarRegularSvg extends TypeSvgSvg {
  className: 'FlStarRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlStarRegularSvg';
    this.attr.addObj({
      name: 'FlStarRegularSvg',
      title: 'FlStarRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
