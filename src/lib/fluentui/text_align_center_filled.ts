...
export class FlTextAlignCenterFilledSvg extends TypeSvgSvg {
  className: 'FlTextAlignCenterFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextAlignCenterFilledSvg';
    this.attr.addObj({
      name: 'FlTextAlignCenterFilledSvg',
      title: 'FlTextAlignCenterFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
