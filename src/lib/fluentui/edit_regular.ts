...
export class FlEditRegularSvg extends TypeSvgSvg {
  className: 'FlEditRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlEditRegularSvg';
    this.attr.addObj({
      name: 'FlEditRegularSvg',
      title: 'FlEditRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
