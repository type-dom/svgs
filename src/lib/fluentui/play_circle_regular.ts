...
export class FlPlayCircleRegularSvg extends TypeSvgSvg {
  className: 'FlPlayCircleRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPlayCircleRegularSvg';
    this.attr.addObj({
      name: 'FlPlayCircleRegularSvg',
      title: 'FlPlayCircleRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
