...
export class FlShareScreenStopFilledSvg extends TypeSvgSvg {
  className: 'FlShareScreenStopFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlShareScreenStopFilledSvg';
    this.attr.addObj({
      name: 'FlShareScreenStopFilledSvg',
      title: 'FlShareScreenStopFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
