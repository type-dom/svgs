...
export class FlCallEndFilledSvg extends TypeSvgSvg {
  className: 'FlCallEndFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCallEndFilledSvg';
    this.attr.addObj({
      name: 'FlCallEndFilledSvg',
      title: 'FlCallEndFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
