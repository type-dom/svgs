...
export class FlBotFilledSvg extends TypeSvgSvg {
  className: 'FlBotFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBotFilledSvg';
    this.attr.addObj({
      name: 'FlBotFilledSvg',
      title: 'FlBotFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
