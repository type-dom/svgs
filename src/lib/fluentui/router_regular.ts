...
export class FlRouterRegularSvg extends TypeSvgSvg {
  className: 'FlRouterRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlRouterRegularSvg';
    this.attr.addObj({
      name: 'FlRouterRegularSvg',
      title: 'FlRouterRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
