...
export class FlTextBulletListSquareRegularSvg extends TypeSvgSvg {
  className: 'FlTextBulletListSquareRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextBulletListSquareRegularSvg';
    this.attr.addObj({
      name: 'FlTextBulletListSquareRegularSvg',
      title: 'FlTextBulletListSquareRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
