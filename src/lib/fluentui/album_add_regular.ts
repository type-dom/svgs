...
export class FlAlbumAddRegularSvg extends TypeSvgSvg {
  className: 'FlAlbumAddRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlAlbumAddRegularSvg';
    this.attr.addObj({
      name: 'FlAlbumAddRegularSvg',
      title: 'FlAlbumAddRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
