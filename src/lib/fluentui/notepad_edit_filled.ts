...
export class FlNotepadEditFilledSvg extends TypeSvgSvg {
  className: 'FlNotepadEditFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlNotepadEditFilledSvg';
    this.attr.addObj({
      name: 'FlNotepadEditFilledSvg',
      title: 'FlNotepadEditFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
