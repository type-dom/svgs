...
export class FlCoinStackFilledSvg extends TypeSvgSvg {
  className: 'FlCoinStackFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCoinStackFilledSvg';
    this.attr.addObj({
      name: 'FlCoinStackFilledSvg',
      title: 'FlCoinStackFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
