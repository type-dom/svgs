...
export class FlImportantRegularSvg extends TypeSvgSvg {
  className: 'FlImportantRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlImportantRegularSvg';
    this.attr.addObj({
      name: 'FlImportantRegularSvg',
      title: 'FlImportantRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
