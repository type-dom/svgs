...
export class FlViewDesktopMobileFilledSvg extends TypeSvgSvg {
  className: 'FlViewDesktopMobileFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlViewDesktopMobileFilledSvg';
    this.attr.addObj({
      name: 'FlViewDesktopMobileFilledSvg',
      title: 'FlViewDesktopMobileFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
