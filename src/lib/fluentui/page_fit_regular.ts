...
export class FlPageFitRegularSvg extends TypeSvgSvg {
  className: 'FlPageFitRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPageFitRegularSvg';
    this.attr.addObj({
      name: 'FlPageFitRegularSvg',
      title: 'FlPageFitRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
