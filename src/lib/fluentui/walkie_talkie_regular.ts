...
export class FlWalkieTalkieRegularSvg extends TypeSvgSvg {
  ...
  constructor(params: TypeProps = {}) {
    ...
    path0.setData(
      'M7.5 6C7.22386 6 7 6.22386 7 6.5V9.5C7 9.77614 7.22386 10 7.5 10H12.5C12.7761 10 13 9.77614 13 9.5V6.5C13 6.22386 12.7761 6 12.5 6H7.5ZM8 9V7H12V9H8Z',
    );
    this.addChild(path0);
    const path1 = new SvgPath({ attrObj: { fill: 'currentColor' }});
    path1.setData(
      'M8 12.5C8 12.2239 8.22386 12 8.5 12H11.5C11.7761 12 12 12.2239 12 12.5C12 12.7761 11.7761 13 11.5 13H8.5C8.22386 13 8 12.7761 8 12.5Z',
    );
    this.addChild(path1);
