...
export class FlErrorCircleRegularSvg extends TypeSvgSvg {
  className: 'FlErrorCircleRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlErrorCircleRegularSvg';
    this.attr.addObj({
      name: 'FlErrorCircleRegularSvg',
      title: 'FlErrorCircleRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
