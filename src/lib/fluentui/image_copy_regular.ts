...
export class FlImageCopyRegularSvg extends TypeSvgSvg {
  className: 'FlImageCopyRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlImageCopyRegularSvg';
    this.attr.addObj({
      name: 'FlImageCopyRegularSvg',
      title: 'FlImageCopyRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
