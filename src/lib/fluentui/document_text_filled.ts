...
export class FlDocumentTextFilledSvg extends TypeSvgSvg {
  className: 'FlDocumentTextFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDocumentTextFilledSvg';
    this.attr.addObj({
      name: 'FlDocumentTextFilledSvg',
      title: 'FlDocumentTextFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
