...
export class FlImageAltTextRegularSvg extends TypeSvgSvg {
  className: 'FlImageAltTextRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlImageAltTextRegularSvg';
    this.attr.addObj({
      name: 'FlImageAltTextRegularSvg',
      title: 'FlImageAltTextRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
