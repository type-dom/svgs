...
export class FlChatWarningRegularSvg extends TypeSvgSvg {
  className: 'FlChatWarningRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlChatWarningRegularSvg';
    this.attr.addObj({
      name: 'FlChatWarningRegularSvg',
      title: 'FlChatWarningRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
