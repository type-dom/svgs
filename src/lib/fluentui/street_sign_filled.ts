...
export class FlStreetSignFilledSvg extends TypeSvgSvg {
  className: 'FlStreetSignFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlStreetSignFilledSvg';
    this.attr.addObj({
      name: 'FlStreetSignFilledSvg',
      title: 'FlStreetSignFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
