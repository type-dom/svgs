...
export class FlBoxFilledSvg extends TypeSvgSvg {
  className: 'FlBoxFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBoxFilledSvg';
    this.attr.addObj({
      name: 'FlBoxFilledSvg',
      title: 'FlBoxFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
