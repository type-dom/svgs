...
export class FlEditOffFilledSvg extends TypeSvgSvg {
  className: 'FlEditOffFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlEditOffFilledSvg';
    this.attr.addObj({
      name: 'FlEditOffFilledSvg',
      title: 'FlEditOffFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
