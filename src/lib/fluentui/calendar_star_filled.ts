...
export class FlCalendarStarFilledSvg extends TypeSvgSvg {
  className: 'FlCalendarStarFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCalendarStarFilledSvg';
    this.attr.addObj({
      name: 'FlCalendarStarFilledSvg',
      title: 'FlCalendarStarFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
