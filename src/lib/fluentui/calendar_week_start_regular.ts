...
export class FlCalendarWeekStartRegularSvg extends TypeSvgSvg {
  className: 'FlCalendarWeekStartRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCalendarWeekStartRegularSvg';
    this.attr.addObj({
      name: 'FlCalendarWeekStartRegularSvg',
      title: 'FlCalendarWeekStartRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
