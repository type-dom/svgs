...
export class FlSearchInfoRegularSvg extends TypeSvgSvg {
  className: 'FlSearchInfoRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlSearchInfoRegularSvg';
    this.attr.addObj({
      name: 'FlSearchInfoRegularSvg',
      title: 'FlSearchInfoRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
