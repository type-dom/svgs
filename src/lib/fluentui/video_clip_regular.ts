...
export class FlVideoClipRegularSvg extends TypeSvgSvg {
  className: 'FlVideoClipRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlVideoClipRegularSvg';
    this.attr.addObj({
      name: 'FlVideoClipRegularSvg',
      title: 'FlVideoClipRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
