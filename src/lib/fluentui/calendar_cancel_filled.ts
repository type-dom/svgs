...
export class FlCalendarCancelFilledSvg extends TypeSvgSvg {
  className: 'FlCalendarCancelFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCalendarCancelFilledSvg';
    this.attr.addObj({
      name: 'FlCalendarCancelFilledSvg',
      title: 'FlCalendarCancelFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
