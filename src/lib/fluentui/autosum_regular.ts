...
export class FlAutosumRegularSvg extends TypeSvgSvg {
  className: 'FlAutosumRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlAutosumRegularSvg';
    this.attr.addObj({
      name: 'FlAutosumRegularSvg',
      title: 'FlAutosumRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
