...
export class FlCalendarCancelRegularSvg extends TypeSvgSvg {
  className: 'FlCalendarCancelRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCalendarCancelRegularSvg';
    this.attr.addObj({
      name: 'FlCalendarCancelRegularSvg',
      title: 'FlCalendarCancelRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
