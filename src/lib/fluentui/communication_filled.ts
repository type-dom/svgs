...
export class FlCommunicationFilledSvg extends TypeSvgSvg {
  className: 'FlCommunicationFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCommunicationFilledSvg';
    this.attr.addObj({
      name: 'FlCommunicationFilledSvg',
      title: 'FlCommunicationFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
