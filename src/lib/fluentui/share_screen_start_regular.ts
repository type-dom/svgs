...
export class FlShareScreenStartRegularSvg extends TypeSvgSvg {
  className: 'FlShareScreenStartRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlShareScreenStartRegularSvg';
    this.attr.addObj({
      name: 'FlShareScreenStartRegularSvg',
      title: 'FlShareScreenStartRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
