...
export class FlFullScreenMaximizeRegularSvg extends TypeSvgSvg {
  className: 'FlFullScreenMaximizeRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlFullScreenMaximizeRegularSvg';
    this.attr.addObj({
      name: 'FlFullScreenMaximizeRegularSvg',
      title: 'FlFullScreenMaximizeRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
