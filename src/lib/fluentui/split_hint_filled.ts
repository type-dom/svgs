...
export class FlSplitHintFilledSvg extends TypeSvgSvg {
  className: 'FlSplitHintFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlSplitHintFilledSvg';
    this.attr.addObj({
      name: 'FlSplitHintFilledSvg',
      title: 'FlSplitHintFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
