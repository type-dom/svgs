...
export class FlArrowRightRegularSvg extends TypeSvgSvg {
  className: 'FlArrowRightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowRightRegularSvg';
    this.attr.addObj({
      name: 'FlArrowRightRegularSvg',
      title: 'FlArrowRightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
