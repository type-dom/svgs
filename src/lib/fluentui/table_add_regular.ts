...
export class FlTableAddRegularSvg extends TypeSvgSvg {
  className: 'FlTableAddRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTableAddRegularSvg';
    this.attr.addObj({
      name: 'FlTableAddRegularSvg',
      title: 'FlTableAddRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
