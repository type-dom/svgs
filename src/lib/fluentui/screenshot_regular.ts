...
export class FlScreenshotRegularSvg extends TypeSvgSvg {
  className: 'FlScreenshotRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlScreenshotRegularSvg';
    this.attr.addObj({
      name: 'FlScreenshotRegularSvg',
      title: 'FlScreenshotRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
