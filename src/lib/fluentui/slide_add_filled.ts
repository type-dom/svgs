...
export class FlSlideAddFilledSvg extends TypeSvgSvg {
  className: 'FlSlideAddFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlSlideAddFilledSvg';
    this.attr.addObj({
      name: 'FlSlideAddFilledSvg',
      title: 'FlSlideAddFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
