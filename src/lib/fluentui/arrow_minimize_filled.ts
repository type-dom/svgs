...
export class FlArrowMinimizeFilledSvg extends TypeSvgSvg {
  className: 'FlArrowMinimizeFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowMinimizeFilledSvg';
    this.attr.addObj({
      name: 'FlArrowMinimizeFilledSvg',
      title: 'FlArrowMinimizeFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
