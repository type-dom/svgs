...
export class FlDocumentTableRegularSvg extends TypeSvgSvg {
  className: 'FlDocumentTableRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDocumentTableRegularSvg';
    this.attr.addObj({
      name: 'FlDocumentTableRegularSvg',
      title: 'FlDocumentTableRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
