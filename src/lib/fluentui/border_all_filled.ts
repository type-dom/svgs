...
export class FlBorderAllFilledSvg extends TypeSvgSvg {
  className: 'FlBorderAllFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBorderAllFilledSvg';
    this.attr.addObj({
      name: 'FlBorderAllFilledSvg',
      title: 'FlBorderAllFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
