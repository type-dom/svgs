...
export class FlLibraryFilledSvg extends TypeSvgSvg {
  className: 'FlLibraryFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlLibraryFilledSvg';
    this.attr.addObj({
      name: 'FlLibraryFilledSvg',
      title: 'FlLibraryFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
