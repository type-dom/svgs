...
export class FlArrowUndoRegularSvg extends TypeSvgSvg {
  className: 'FlArrowUndoRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowUndoRegularSvg';
    this.attr.addObj({
      name: 'FlArrowUndoRegularSvg',
      title: 'FlArrowUndoRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
