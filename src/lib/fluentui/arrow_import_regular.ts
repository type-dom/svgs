...
export class FlArrowImportRegularSvg extends TypeSvgSvg {
  className: 'FlArrowImportRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowImportRegularSvg';
    this.attr.addObj({
      name: 'FlArrowImportRegularSvg',
      title: 'FlArrowImportRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
