...
export class FlMoleculeFilledSvg extends TypeSvgSvg {
  className: 'FlMoleculeFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlMoleculeFilledSvg';
    this.attr.addObj({
      name: 'FlMoleculeFilledSvg',
      title: 'FlMoleculeFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
