...
export class FlQuestionCircleRegularSvg extends TypeSvgSvg {
  className: 'FlQuestionCircleRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlQuestionCircleRegularSvg';
    this.attr.addObj({
      name: 'FlQuestionCircleRegularSvg',
      title: 'FlQuestionCircleRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
