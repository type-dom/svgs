...
export class FlArrowStepBackRegularSvg extends TypeSvgSvg {
  className: 'FlArrowStepBackRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowStepBackRegularSvg';
    this.attr.addObj({
      name: 'FlArrowStepBackRegularSvg',
      title: 'FlArrowStepBackRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
