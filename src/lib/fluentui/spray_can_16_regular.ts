...
export class FlSprayCan16RegularSvg extends TypeSvgSvg {
  className: 'FlSprayCan16RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlSprayCan16RegularSvg';
    this.attr.addObj({
      name: 'FlSprayCan16RegularSvg',
      title: 'FlSprayCan16RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 16 16',
    });
