...
export class FlArrowDownloadRegularSvg extends TypeSvgSvg {
  className: 'FlArrowDownloadRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowDownloadRegularSvg';
    this.attr.addObj({
      name: 'FlArrowDownloadRegularSvg',
      title: 'FlArrowDownloadRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
