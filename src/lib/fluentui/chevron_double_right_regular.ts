...
export class FlChevronDoubleRightRegularSvg extends TypeSvgSvg {
  className: 'FlChevronDoubleRightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlChevronDoubleRightRegularSvg';
    this.attr.addObj({
      name: 'FlChevronDoubleRightRegularSvg',
      title: 'FlChevronDoubleRightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
