...
export class FlWindowPlayRegularSvg extends TypeSvgSvg {
  className: 'FlWindowPlayRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlWindowPlayRegularSvg';
    this.attr.addObj({
      name: 'FlWindowPlayRegularSvg',
      title: 'FlWindowPlayRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
