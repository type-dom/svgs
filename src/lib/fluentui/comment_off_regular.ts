...
export class FlCommentOffRegularSvg extends TypeSvgSvg {
  className: 'FlCommentOffRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCommentOffRegularSvg';
    this.attr.addObj({
      name: 'FlCommentOffRegularSvg',
      title: 'FlCommentOffRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
