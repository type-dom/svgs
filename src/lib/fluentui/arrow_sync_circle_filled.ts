...
export class FlArrowSyncCircleFilledSvg extends TypeSvgSvg {
  className: 'FlArrowSyncCircleFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowSyncCircleFilledSvg';
    this.attr.addObj({
      name: 'FlArrowSyncCircleFilledSvg',
      title: 'FlArrowSyncCircleFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
