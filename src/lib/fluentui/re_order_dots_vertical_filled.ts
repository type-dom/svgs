...
export class FlReOrderDotsVerticalFilledSvg extends TypeSvgSvg {
  className: 'FlReOrderDotsVerticalFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlReOrderDotsVerticalFilledSvg';
    this.attr.addObj({
      name: 'FlReOrderDotsVerticalFilledSvg',
      title: 'FlReOrderDotsVerticalFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
