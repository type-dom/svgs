...
export class FlClipboardLetterRegularSvg extends TypeSvgSvg {
  className: 'FlClipboardLetterRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlClipboardLetterRegularSvg';
    this.attr.addObj({
      name: 'FlClipboardLetterRegularSvg',
      title: 'FlClipboardLetterRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
