...
export class FlCalendarClockRegularSvg extends TypeSvgSvg {
  className: 'FlCalendarClockRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCalendarClockRegularSvg';
    this.attr.addObj({
      name: 'FlCalendarClockRegularSvg',
      title: 'FlCalendarClockRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
