...
export class FlArrowStepBackFilledSvg extends TypeSvgSvg {
  className: 'FlArrowStepBackFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowStepBackFilledSvg';
    this.attr.addObj({
      name: 'FlArrowStepBackFilledSvg',
      title: 'FlArrowStepBackFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
