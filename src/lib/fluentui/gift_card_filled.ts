...
export class FlGiftCardFilledSvg extends TypeSvgSvg {
  className: 'FlGiftCardFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlGiftCardFilledSvg';
    this.attr.addObj({
      name: 'FlGiftCardFilledSvg',
      title: 'FlGiftCardFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
