...
export class FlAutoFitHeightFilledSvg extends TypeSvgSvg {
  className: 'FlAutoFitHeightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlAutoFitHeightFilledSvg';
    this.attr.addObj({
      name: 'FlAutoFitHeightFilledSvg',
      title: 'FlAutoFitHeightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
