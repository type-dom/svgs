...
export class FlDoorArrowRightRegularSvg extends TypeSvgSvg {
  className: 'FlDoorArrowRightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDoorArrowRightRegularSvg';
    this.attr.addObj({
      name: 'FlDoorArrowRightRegularSvg',
      title: 'FlDoorArrowRightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
