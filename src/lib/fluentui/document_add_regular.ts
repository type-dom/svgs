...
export class FlDocumentAddRegularSvg extends TypeSvgSvg {
  className: 'FlDocumentAddRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDocumentAddRegularSvg';
    this.attr.addObj({
      name: 'FlDocumentAddRegularSvg',
      title: 'FlDocumentAddRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
