...
export class FlNotebookSectionArrowRightRegularSvg extends TypeSvgSvg {
  className: 'FlNotebookSectionArrowRightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlNotebookSectionArrowRightRegularSvg';
    this.attr.addObj({
      name: 'FlNotebookSectionArrowRightRegularSvg',
      title: 'FlNotebookSectionArrowRightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
