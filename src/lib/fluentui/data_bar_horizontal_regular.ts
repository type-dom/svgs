...
export class FlDataBarHorizontalRegularSvg extends TypeSvgSvg {
  className: 'FlDataBarHorizontalRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDataBarHorizontalRegularSvg';
    this.attr.addObj({
      name: 'FlDataBarHorizontalRegularSvg',
      title: 'FlDataBarHorizontalRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
