...
export class FlWindowConsoleRegularSvg extends TypeSvgSvg {
  className: 'FlWindowConsoleRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlWindowConsoleRegularSvg';
    this.attr.addObj({
      name: 'FlWindowConsoleRegularSvg',
      title: 'FlWindowConsoleRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
