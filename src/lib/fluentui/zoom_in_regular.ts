...
export class FlZoomInRegularSvg extends TypeSvgSvg {
  className: 'FlZoomInRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlZoomInRegularSvg';
    this.attr.addObj({
      name: 'FlZoomInRegularSvg',
      title: 'FlZoomInRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
