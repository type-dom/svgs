...
export class FlArrowHookUpRightFilledSvg extends TypeSvgSvg {
  className: 'FlArrowHookUpRightFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowHookUpRightFilledSvg';
    this.attr.addObj({
      name: 'FlArrowHookUpRightFilledSvg',
      title: 'FlArrowHookUpRightFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
