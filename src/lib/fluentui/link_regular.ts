...
export class FlLinkRegularSvg extends TypeSvgSvg {
  className: 'FlLinkRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlLinkRegularSvg';
    this.attr.addObj({
      name: 'FlLinkRegularSvg',
      title: 'FlLinkRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
