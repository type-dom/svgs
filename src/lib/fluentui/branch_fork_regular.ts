...
export class FlBranchForkRegularSvg extends TypeSvgSvg {
  className: 'FlBranchForkRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBranchForkRegularSvg';
    this.attr.addObj({
      name: 'FlBranchForkRegularSvg',
      title: 'FlBranchForkRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
