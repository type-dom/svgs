...
export class FlTrayItemAddFilledSvg extends TypeSvgSvg {
  className: 'FlTrayItemAddFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTrayItemAddFilledSvg';
    this.attr.addObj({
      name: 'FlTrayItemAddFilledSvg',
      title: 'FlTrayItemAddFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
