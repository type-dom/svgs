...
export class FlArrowRedoRegularSvg extends TypeSvgSvg {
  className: 'FlArrowRedoRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowRedoRegularSvg';
    this.attr.addObj({
      name: 'FlArrowRedoRegularSvg',
      title: 'FlArrowRedoRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
