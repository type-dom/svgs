...
export class FlDataLineRegularSvg extends TypeSvgSvg {
  className: 'FlDataLineRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlDataLineRegularSvg';
    this.attr.addObj({
      name: 'FlDataLineRegularSvg',
      title: 'FlDataLineRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
