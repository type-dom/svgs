...
export class FlTableCursorRegularSvg extends TypeSvgSvg {
  className: 'FlTableCursorRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTableCursorRegularSvg';
    this.attr.addObj({
      name: 'FlTableCursorRegularSvg',
      title: 'FlTableCursorRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
