...
export class FlComponent2DoubleTapSwipeDown24RegularSvg extends TypeSvgSvg {
  className: 'FlComponent2DoubleTapSwipeDown24RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlComponent2DoubleTapSwipeDown24RegularSvg';
    this.attr.addObj({
      name: 'FlComponent2DoubleTapSwipeDown24RegularSvg',
      title: 'FlComponent2DoubleTapSwipeDown24RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 24 24',
    });
