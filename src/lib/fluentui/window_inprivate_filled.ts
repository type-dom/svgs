...
export class FlWindowInprivateFilledSvg extends TypeSvgSvg {
  className: 'FlWindowInprivateFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlWindowInprivateFilledSvg';
    this.attr.addObj({
      name: 'FlWindowInprivateFilledSvg',
      title: 'FlWindowInprivateFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
