...
export class FlPanelTopExpandRegularSvg extends TypeSvgSvg {
  className: 'FlPanelTopExpandRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPanelTopExpandRegularSvg';
    this.attr.addObj({
      name: 'FlPanelTopExpandRegularSvg',
      title: 'FlPanelTopExpandRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
