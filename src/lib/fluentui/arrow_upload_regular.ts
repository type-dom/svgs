...
export class FlArrowUploadRegularSvg extends TypeSvgSvg {
  className: 'FlArrowUploadRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowUploadRegularSvg';
    this.attr.addObj({
      name: 'FlArrowUploadRegularSvg',
      title: 'FlArrowUploadRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
