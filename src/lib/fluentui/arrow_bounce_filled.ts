...
export class FlArrowBounceFilledSvg extends TypeSvgSvg {
  className: 'FlArrowBounceFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowBounceFilledSvg';
    this.attr.addObj({
      name: 'FlArrowBounceFilledSvg',
      title: 'FlArrowBounceFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
