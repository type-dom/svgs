...
export class FlAirplaneFilledSvg extends TypeSvgSvg {
  className: 'FlAirplaneFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlAirplaneFilledSvg';
    this.attr.addObj({
      name: 'FlAirplaneFilledSvg',
      title: 'FlAirplaneFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
