...
export class FlWarningFilledSvg extends TypeSvgSvg {
  className: 'FlWarningFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlWarningFilledSvg';
    this.attr.addObj({
      name: 'FlWarningFilledSvg',
      title: 'FlWarningFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
