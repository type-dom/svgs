...
export class FlPictureInPictureEnterRegularSvg extends TypeSvgSvg {
  className: 'FlPictureInPictureEnterRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPictureInPictureEnterRegularSvg';
    this.attr.addObj({
      name: 'FlPictureInPictureEnterRegularSvg',
      title: 'FlPictureInPictureEnterRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
