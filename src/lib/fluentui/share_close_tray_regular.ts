...
export class FlShareCloseTrayRegularSvg extends TypeSvgSvg {
  className: 'FlShareCloseTrayRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlShareCloseTrayRegularSvg';
    this.attr.addObj({
      name: 'FlShareCloseTrayRegularSvg',
      title: 'FlShareCloseTrayRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
