...
export class FlSplitHintRegularSvg extends TypeSvgSvg {
  className: 'FlSplitHintRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlSplitHintRegularSvg';
    this.attr.addObj({
      name: 'FlSplitHintRegularSvg',
      title: 'FlSplitHintRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
