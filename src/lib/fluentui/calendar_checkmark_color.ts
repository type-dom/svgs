...
export class FlCalendarCheckmarkColorSvg extends TypeSvgSvg {
  ...
  constructor(params: SvgProps = {}) {
    ...
    path0.setData("M3 6H17V14.5C17 15.8807 15.8807 17 14.5 17H5.5C4.11929 17 3 15.8807 3 14.5V6Z");
    this.addChild(path0);
    const path1 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path1.setData("M3 6H17V14.5C17 15.8807 15.8807 17 14.5 17H5.5C4.11929 17 3 15.8807 3 14.5V6Z");
    this.addChild(path1);
    const path2 = new SvgPath({ attrObj: { fill: "currentColor" } });
    path2.setData("M3 6H17V14.5C17 15.8807 15.8807 17 14.5 17H5.5C4.11929 17 3 15.8807 3 14.5V6Z");
    this.addChild(path2);
