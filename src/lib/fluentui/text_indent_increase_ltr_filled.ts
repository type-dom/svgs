...
export class FlTextIndentIncreaseLtrFilledSvg extends TypeSvgSvg {
  className: 'FlTextIndentIncreaseLtrFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlTextIndentIncreaseLtrFilledSvg';
    this.attr.addObj({
      name: 'FlTextIndentIncreaseLtrFilledSvg',
      title: 'FlTextIndentIncreaseLtrFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
