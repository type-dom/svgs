...
export class FlTextIndentDecreaseRtl90RegularSvg extends TypeSvgSvg {
  className: 'FlTextIndentDecreaseRtl90RegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlTextIndentDecreaseRtl90RegularSvg';
    this.attr.addObj({
      name: 'FlTextIndentDecreaseRtl90RegularSvg',
      title: 'FlTextIndentDecreaseRtl90RegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
