...
export class FlPersonInfoRegularSvg extends TypeSvgSvg {
  className: 'FlPersonInfoRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPersonInfoRegularSvg';
    this.attr.addObj({
      name: 'FlPersonInfoRegularSvg',
      title: 'FlPersonInfoRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
