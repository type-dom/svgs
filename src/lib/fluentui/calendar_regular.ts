...
export class FlCalendarRegularSvg extends TypeSvgSvg {
  className: 'FlCalendarRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCalendarRegularSvg';
    this.attr.addObj({
      name: 'FlCalendarRegularSvg',
      title: 'FlCalendarRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
