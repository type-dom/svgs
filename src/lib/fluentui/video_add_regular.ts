...
export class FlVideoAddRegularSvg extends TypeSvgSvg {
  className: 'FlVideoAddRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlVideoAddRegularSvg';
    this.attr.addObj({
      name: 'FlVideoAddRegularSvg',
      title: 'FlVideoAddRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
