...
export class FlArrowCurveUpRightRegularSvg extends TypeSvgSvg {
  className: 'FlArrowCurveUpRightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlArrowCurveUpRightRegularSvg';
    this.attr.addObj({
      name: 'FlArrowCurveUpRightRegularSvg',
      title: 'FlArrowCurveUpRightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
