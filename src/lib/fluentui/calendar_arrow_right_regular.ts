...
export class FlCalendarArrowRightRegularSvg extends TypeSvgSvg {
  className: 'FlCalendarArrowRightRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlCalendarArrowRightRegularSvg';
    this.attr.addObj({
      name: 'FlCalendarArrowRightRegularSvg',
      title: 'FlCalendarArrowRightRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
