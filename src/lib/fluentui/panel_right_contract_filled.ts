...
export class FlPanelRightContractFilledSvg extends TypeSvgSvg {
  className: 'FlPanelRightContractFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlPanelRightContractFilledSvg';
    this.attr.addObj({
      name: 'FlPanelRightContractFilledSvg',
      title: 'FlPanelRightContractFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
