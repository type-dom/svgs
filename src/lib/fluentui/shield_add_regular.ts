...
export class FlShieldAddRegularSvg extends TypeSvgSvg {
  className: 'FlShieldAddRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlShieldAddRegularSvg';
    this.attr.addObj({
      name: 'FlShieldAddRegularSvg',
      title: 'FlShieldAddRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
