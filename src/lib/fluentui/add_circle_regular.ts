...
export class FlAddCircleRegularSvg extends TypeSvgSvg {
  className: 'FlAddCircleRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlAddCircleRegularSvg';
    this.attr.addObj({
      name: 'FlAddCircleRegularSvg',
      title: 'FlAddCircleRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
