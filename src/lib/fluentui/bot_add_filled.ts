...
export class FlBotAddFilledSvg extends TypeSvgSvg {
  className: 'FlBotAddFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlBotAddFilledSvg';
    this.attr.addObj({
      name: 'FlBotAddFilledSvg',
      title: 'FlBotAddFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
