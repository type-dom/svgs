...
export class FlEngineRegularSvg extends TypeSvgSvg {
  className: 'FlEngineRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlEngineRegularSvg';
    this.attr.addObj({
      name: 'FlEngineRegularSvg',
      title: 'FlEngineRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
