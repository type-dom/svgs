...
export class FlArrowTrendingFilledSvg extends TypeSvgSvg {
  className: 'FlArrowTrendingFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowTrendingFilledSvg';
    this.attr.addObj({
      name: 'FlArrowTrendingFilledSvg',
      title: 'FlArrowTrendingFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
