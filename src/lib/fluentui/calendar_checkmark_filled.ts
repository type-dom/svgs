...
export class FlCalendarCheckmarkFilledSvg extends TypeSvgSvg {
  className: 'FlCalendarCheckmarkFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlCalendarCheckmarkFilledSvg';
    this.attr.addObj({
      name: 'FlCalendarCheckmarkFilledSvg',
      title: 'FlCalendarCheckmarkFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
