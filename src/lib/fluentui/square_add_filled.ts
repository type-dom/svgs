...
export class FlSquareAddFilledSvg extends TypeSvgSvg {
  className: 'FlSquareAddFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlSquareAddFilledSvg';
    this.attr.addObj({
      name: 'FlSquareAddFilledSvg',
      title: 'FlSquareAddFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
