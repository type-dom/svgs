...
export class FlPersonStarFilledSvg extends TypeSvgSvg {
  className: 'FlPersonStarFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlPersonStarFilledSvg';
    this.attr.addObj({
      name: 'FlPersonStarFilledSvg',
      title: 'FlPersonStarFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
