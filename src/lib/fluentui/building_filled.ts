...
export class FlBuildingFilledSvg extends TypeSvgSvg {
  className: 'FlBuildingFilledSvg';
  override childNodes: SvgPath[];
  constructor(params: TypeProps = {}) {
    super();
    this.className = 'FlBuildingFilledSvg';
    this.attr.addObj({
      name: 'FlBuildingFilledSvg',
      title: 'FlBuildingFilledSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
