...
export class FlDataTrendingRegularSvg extends TypeSvgSvg {
  className: 'FlDataTrendingRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlDataTrendingRegularSvg';
    this.attr.addObj({
      name: 'FlDataTrendingRegularSvg',
      title: 'FlDataTrendingRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
