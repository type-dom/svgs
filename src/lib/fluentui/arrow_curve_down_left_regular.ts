...
export class FlArrowCurveDownLeftRegularSvg extends TypeSvgSvg {
  className: 'FlArrowCurveDownLeftRegularSvg';
  override childNodes: SvgPath[];
  constructor(params: ITypeConfig = {}) {
    super();
    this.className = 'FlArrowCurveDownLeftRegularSvg';
    this.attr.addObj({
      name: 'FlArrowCurveDownLeftRegularSvg',
      title: 'FlArrowCurveDownLeftRegularSvg'
    });
    this.attr.addObj({
      viewBox: '0 0 20 20',
    });
