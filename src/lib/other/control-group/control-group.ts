...
export class ControlGroupSvg extends TypeSvgSvg {
  ...
  constructor(params: SvgProps = {}) {
    ...
    this.path.setData(
      'M241.28 208h-192a35.2 35.2 0 0 1-38.4-35.2 35.2 35.2 0 0 1 35.2-34.56h195.2a34.56 34.56 0 0 1 34.56 34.56 35.2 35.2 0 0 1-34.56 35.2zM984.32 208H463.36a35.2 35.2 0 0 1-34.56-35.2 34.56 34.56 0 0 1 34.56-34.56h520.96a35.2 35.2 0 0 1 35.2 34.56 35.2 35.2 0 0 1-35.2 35.2z',
