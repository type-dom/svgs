...
export class RectangleSvg extends TypeSvgSvg {
  ...
  constructor(params: TypeProps = {}) {
    ...
    this.path.setData(
      'M841.34 959.36H182.66c-65.06 0-117.99-52.94-117.99-118.02V182.69c0-65.08 52.94-118.04 117.99-118.04h658.68c65.06 0 117.99 52.96 117.99 118.04v658.65c0 65.08-52.93 118.02-117.99 118.02z',
