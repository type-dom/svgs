...
export class MisTypescriptSvg extends TypeSvgSvg {
  className: "MisTypescriptSvg";
  override childNodes: SvgPath[];
  constructor(params: SvgProps = {}) {
    super(params);
    this.className = "MisTypescriptSvg";
    addAttrObj(this, {
      name: "MisTypescriptSvg",
    });
    addAttrObj(this, {
