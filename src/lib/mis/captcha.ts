...
export class MisCaptchaSvg extends TypeSvgSvg {
  className: "MisCaptchaSvg";
  override childNodes: SvgPath[];
  constructor(params: SvgProps = {}) {
    super(params);
    this.className = "MisCaptchaSvg";
    addAttrObj(this, {
      name: "MisCaptchaSvg",
    });
    addAttrObj(this, {
