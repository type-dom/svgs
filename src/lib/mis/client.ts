...
export class MisClientSvg extends TypeSvgSvg {
  className: "MisClientSvg";
  override childNodes: SvgPath[];
  constructor(params: SvgProps = {}) {
    super(params);
    this.className = "MisClientSvg";
    addAttrObj(this, {
      name: "MisClientSvg",
    });
    addAttrObj(this, {
