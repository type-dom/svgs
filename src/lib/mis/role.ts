...
export class MisRoleSvg extends TypeSvgSvg {
  className: "MisRoleSvg";
  override childNodes: SvgPath[];
  constructor(params: SvgProps = {}) {
    super(params);
    this.className = "MisRoleSvg";
    addAttrObj(this, {
      name: "MisRoleSvg",
    });
    addAttrObj(this, {
