...
export class MisGiteeSvg extends TypeSvgSvg {
  className: "MisGiteeSvg";
  override childNodes: SvgPath[];
  constructor(params: SvgProps = {}) {
    super(params);
    this.className = "MisGiteeSvg";
    addAttrObj(this, {
      name: "MisGiteeSvg",
    });
    addAttrObj(this, {
