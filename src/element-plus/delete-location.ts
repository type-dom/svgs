...
export class DeleteLocationSvg extends TypeSvgSvg {
  className: 'DeleteLocationSvg';
  childNodes: SvgPath[];
  constructor(public parent: TypeHtml) {
    super();
    this.className = 'DeleteLocationSvg';
    ...
    path2.setData("M384 384h256q32 0 32 32t-32 32H384q-32 0-32-32t32-32z");
